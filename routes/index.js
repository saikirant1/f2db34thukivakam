...
router.get('/', function (req, res) { 
    res.render('index', { title: 'desiRestaruant App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'desiRestaruant App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'desiRestaruant App Login', user : req.user }); 
}); 
